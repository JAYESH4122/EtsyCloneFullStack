...
const SubFooter = ({ onLoaded }: SectionProps) => {
  ...
  return (
    <div
      onClick={() => {
        navigate("/edit/subfooterSection");
      }}
    >
      <div className="subfooter-section-one">
        <div className="subfooter-section-one-email-text">
          <p>{subfooterSection.emailSection.text}</p>
        </div>
        <div className="subfooter-section-one-input-field">
          <div className="input-field-container">
            <input
              type="text"
              placeholder={subfooterSection.emailSection.placeholder}
            />
            <p>{subfooterSection.emailSection.buttonText}</p>
          </div>
        </div>
      </div>
      <div className="subfooter-section-two">
        <div className="subfooter-container-section-two">
          ...
          <div className="sub-footer-text">
            <span>{subfooterSection.renewableEnergySection.text}</span>
          </div>
        </div>
      </div>
    </div>
